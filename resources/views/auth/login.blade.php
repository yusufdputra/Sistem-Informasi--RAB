...
<div class="wrapper-page">
    <div class="text-center">
        <a class="p1 text-primary">SISTEM INFORMASI RAB</a>
        <h5 class="text-white m-t-0 font-600">PT. Sejahtera Mandiri Pekanbaru</h5>
    </div>
    <div class="m-t-40 card-box">
        <div class="text-center">
            <img src="{{asset('adminto/images/brand/sejahtera.png')}}" height="100px" alt="">
            <h4 class="text-uppercase text-white font-bold m-b-0">Sign In</h4>
        </div>
        <div class="p-20">
