...
<div id="tambah-modal" class="modal-demo">
    ...
    <div class="custom-modal-text">
        ...
        <div class="p-20">
            <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('kategori.store')}}"
                method="POST">
                {{csrf_field()}}
...
<div id="edit-modal" class="modal-demo">
    ...
    <div class="custom-modal-text">
        ...
        <div class="p-20">
            ...
            <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('kategori.update')}}"
                method="POST">
                {{csrf_field()}}
...
<div id="hapus-modal" class="modal-demo">
    ...
    <div class="custom-modal-text">
        ...
        <div class="p-20">
            ...
            <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('kategori.hapus')}}"
                method="POST">
                {{csrf_field()}}
                <div>
