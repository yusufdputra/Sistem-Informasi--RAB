            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <select required class="form-control " onchange="sorting()" id="sort_kategori"
                            name="sort_kategori">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#edit-modal" data-animation="sign" data-plugin="custommodal"
                                ...
                                data-overlayColor="#36404a" class="btn btn-success btn-sm modal_edit"><i
...
<div id="tambah-modal" class="modal-demo">
    ...
    <div class="custom-modal-text">
        ...
        <div class="p-20 text-left">
            <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('barang.store')}}"
                method="POST">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12">
                        <input class="form-control" type="text" autocomplete="off" name="suplier" required=""
...
<div id="edit-modal" class="modal-demo">
    ...
    <div class="custom-modal-text">
        ...
        <div class="p-20 text-left">
            ...
            <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('barang.update')}}"
                method="POST">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    <label>Nama barang</label>
                    <div class="col-xs-12">
                        <input class="form-control" type="text" autocomplete="off" id="edit_nama" name="nama"
                ...
                <div class="form-group">
                    <label for="">Nama Suplier</label>
                    <div class="col-xs-12">
                        <input class="form-control" type="text" id="edit_suplier" autocomplete="off" name="suplier"
                ...
                <div class="form-group">
                    <label for="">Harga Barang</label>
                    <div class="col-xs-12">
                        <input class="form-control" min="0" type="number" id="edit_harga" autocomplete="off"
...
<div id="hapus-modal" class="modal-demo">
    ...
    <div class="custom-modal-text">
        ...
        <div class="p-20">
            ...
            <form class="form-horizontal m-t-20" enctype="multipart/form-data" action="{{route('barang.hapus')}}"
                method="POST">
                {{csrf_field()}}
                <div>
